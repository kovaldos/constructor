...
/***/ "./js/blocks/banner-slider.js":
/*!************************************!*\
  !*** ./js/blocks/banner-slider.js ***!
  \************************************/
/*! exports provided: bannerSlider */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "bannerSlider", function() { return bannerSlider; });
var bannerSlider = function bannerSlider() {
  var bannerSliderCheck = document.querySelectorAll('.banner__slider');

  if (bannerSliderCheck.length) {
    bannerSliderCheck.forEach(function (slider, i) {
      slider.classList.add("banner__slider--".concat(i));
      var bannerSliderInit = new Swiper(".banner__slider--".concat(i), {
        loop: true,
        pagination: {
          el: '.swiper-pagination'
        },
        navigation: {
          nextEl: ".banner__slider--".concat(i, " .banner__slider-btn--next"),
          prevEl: ".banner__slider--".concat(i, " .banner__slider-btn--prev")
        }
      });
    });
  }
...
var initBurgerMenu = function initBurgerMenu() {
  var burgerMenuToggles = document.querySelectorAll('[data-toggle="burger-menu-toggle"]');

  if (burgerMenuToggles.length) {
    burgerMenuToggles.forEach(function (burgerMenuToggle) {
      burgerMenuToggle.addEventListener('click', function () {
        var burgerMenuBody = this.closest('.main-nav').querySelector('[data-burger-menu="burger-menu-body"]');
        var subMenu = this.closest('.main-nav').querySelector('[data-menu="sub-menu"]');
        this.classList.toggle('is-active');
        burgerMenuBody.classList.toggle('is-active');
        subMenu.classList.toggle('is-active'); // document.body.classList.toggle('scroll-lock');
      });
    });
  }
};
...
/***/ "./js/blocks/modal-feedback.js":
/*!*************************************!*\
  !*** ./js/blocks/modal-feedback.js ***!
  \*************************************/
/*! exports provided: modalFeedbackInit */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "modalFeedbackInit", function() { return modalFeedbackInit; });
/* harmony import */ var _utils_modal__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/modal */ "./js/utils/modal.js");



var modalFeedbackInit = function modalFeedbackInit() {
  window.addEventListener('load', function () {
    var modalFeedback = document.querySelectorAll('.modal--feedback');

    if (modalFeedback) {
      var modalSuccess = document.querySelector('.modal--success');
      modalFeedback.forEach(function (modal) {
        modal.addEventListener('submit', function (e) {
          var modalFeedbackFrom = modal.querySelector('form');
          e.preventDefault();
          Object(_utils_modal__WEBPACK_IMPORTED_MODULE_0__["closeModal"])(modal);
...
/***/ "./js/blocks/modal-login.js":
/*!**********************************!*\
  !*** ./js/blocks/modal-login.js ***!
  \**********************************/
/*! exports provided: modalLoginInit */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "modalLoginInit", function() { return modalLoginInit; });
/* harmony import */ var _utils_modal__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/modal */ "./js/utils/modal.js");


var modalLoginInit = function modalLoginInit() {
  window.addEventListener('load', function () {
    var modalLogin = document.querySelectorAll('.modal--login');

    if (modalLogin) {
      modalLogin.forEach(function (modal) {
        var modalRegistrationBtn = modal.querySelector("[data-modal=\"registration\"]");
...
/***/ "./js/blocks/modal-registration.js":
/*!*****************************************!*\
  !*** ./js/blocks/modal-registration.js ***!
  \*****************************************/
/*! exports provided: modalRegistrationInit */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "modalRegistrationInit", function() { return modalRegistrationInit; });
/* harmony import */ var _utils_modal__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/modal */ "./js/utils/modal.js");


var modalRegistrationInit = function modalRegistrationInit() {
  window.addEventListener('load', function () {
    var modalRegistration = document.querySelectorAll('.modal--registration');

    if (modalRegistration) {
      modalRegistration.forEach(function (modal) {
        var modalLoginBtn = modal.querySelector("[data-modal=\"login\"]");
...
/***/ "./js/blocks/portfolio-slider.js":
/*!***************************************!*\
  !*** ./js/blocks/portfolio-slider.js ***!
  \***************************************/
/*! exports provided: portfolioSlider */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "portfolioSlider", function() { return portfolioSlider; });
var portfolioSlider = function portfolioSlider() {
  var portfolioSliderCheck = document.querySelectorAll('.portfolio__slider');

  if (portfolioSliderCheck.length) {
    portfolioSliderCheck.forEach(function (slider, i) {
      slider.classList.add("portfolio__slider--".concat(i));
      var portfolioSliderInit = new Swiper(".portfolio__slider--".concat(i), {
        loop: true,
        slidesPerView: 'auto',
        navigation: {
          nextEl: ".portfolio__slider--".concat(i, " .portfolio__slider-btn--next"),
          prevEl: ".portfolio__slider--".concat(i, " .portfolio__slider-btn--prev")
        },
        breakpoints: {
...
/* harmony import */ var _blocks_banner_slider__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./blocks/banner-slider */ "./js/blocks/banner-slider.js");
/* harmony import */ var _blocks_portfolio_slider__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./blocks/portfolio-slider */ "./js/blocks/portfolio-slider.js");
/* harmony import */ var _blocks_modal_feedback__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./blocks/modal-feedback */ "./js/blocks/modal-feedback.js");
/* harmony import */ var _blocks_modal_login__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./blocks/modal-login */ "./js/blocks/modal-login.js");
/* harmony import */ var _blocks_modal_registration__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./blocks/modal-registration */ "./js/blocks/modal-registration.js");
/* harmony import */ var _modules_custom_select__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/custom-select */ "./js/modules/custom-select.js");
/* harmony import */ var _modules_init_accordion__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/init-accordion */ "./js/modules/init-accordion.js");
/* harmony import */ var _blocks_burger_menu__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./blocks/burger-menu */ "./js/blocks/burger-menu.js");
...
Object(_modules_custom_select__WEBPACK_IMPORTED_MODULE_8__["initCustomSelect"])();
Object(_modules_init_modals__WEBPACK_IMPORTED_MODULE_2__["initModals"])();
Object(_modules_init_accordion__WEBPACK_IMPORTED_MODULE_9__["initAccordions"])(); // Blocks

Object(_blocks_burger_menu__WEBPACK_IMPORTED_MODULE_10__["initBurgerMenu"])();
Object(_blocks_banner_slider__WEBPACK_IMPORTED_MODULE_3__["bannerSlider"])();
Object(_blocks_portfolio_slider__WEBPACK_IMPORTED_MODULE_4__["portfolioSlider"])();
Object(_blocks_modal_feedback__WEBPACK_IMPORTED_MODULE_5__["modalFeedbackInit"])();
Object(_blocks_modal_login__WEBPACK_IMPORTED_MODULE_6__["modalLoginInit"])();
Object(_blocks_modal_registration__WEBPACK_IMPORTED_MODULE_7__["modalRegistrationInit"])();
...
var initCustomSelect = function initCustomSelect() {
  var select = function select() {
    var innerSelects = document.querySelectorAll('.custom-select__inner');
    var selectItem = document.querySelectorAll('.custom-select__label-item');
    innerSelects.forEach(function (item) {
    ...
    function selectChoose() {
      ...
      var location = this.closest('.custom-select');
      var currentText = location.querySelector('.custom-select__current ');
...
var initAccordions = function initAccordions() {
  accordions = new _utils_accordions__WEBPACK_IMPORTED_MODULE_0__["Accordions"](); // Используйте в разработке экспортируемую переменную accordions, window сделан для бэкэнда
...
var modalLoginBtns = document.querySelectorAll('[data-modal="login"]');
var modalRegistration = document.querySelector('.modal--registration');
var modalRegistrationBtns = document.querySelectorAll('[data-modal="registration"]'); // аргументы setupModal(modal, closeCallback, modalBtns, openCallback, noPrevDefault, preventScrollLock)
...
var initModals = function initModals() {
  ...
  if (modalLogin) {
    Object(_utils_modal__WEBPACK_IMPORTED_MODULE_0__["setupModal"])(modalLogin, false, modalLoginBtns, false, false);
  }

  if (modalRegistration) {
    Object(_utils_modal__WEBPACK_IMPORTED_MODULE_0__["setupModal"])(modalRegistration, false, modalRegistrationBtns, false, false);
  }
};
